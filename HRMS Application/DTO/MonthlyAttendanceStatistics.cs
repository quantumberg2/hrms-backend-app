namespace HRMS_Application.DTO
{
    public class MonthlyAttendanceStatistics
    {
        ...
        public string? AverageOvertime {  get; set; }
        public string? TotalWorkplusOT { get; set; }
        public string? TotalOverTime { get; set; }
        public string ?LessHoursTime { get; set; } // Add LessHours property
    ...
    public class DateWiseAttendance
    {
        ...
        public string? WorkTime { get; set; } // Store daily worktime
        public string? Overtime { get; set; } // Store daily overtime

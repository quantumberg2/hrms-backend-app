namespace HRMS_Application.DTO
{
    public class MonthlyAttendanceStatistics
    {
        ...
        public double TotalHoursWorked { get; set; } // considering the time range and between timecount and divide by Total workingdays then get toatl hours for workingdays 
        public double AverageWorkHours { get; set; } // considring thetimein and timeout when the status = present and between calculate the time and divide by the number of days present in a month
        public double AvgTimein { get; set; }     // Timein/no of timein in a month *100
        public double AvgTimeouT {  get; set; } // Timeout/no of timeout in amonth * 100
